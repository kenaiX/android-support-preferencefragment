...
public abstract class PreferenceFragment extends Fragment implements
	...
	public View onCreateView(LayoutInflater paramLayoutInflater, ViewGroup paramViewGroup,
			Bundle paramBundle) {
        View view = paramLayoutInflater.inflate(R.layout.preference_list_fragment, paramViewGroup,
                false);
        ...
        try {
            ...
            obj = c.newInstance();
            field = c.getField("preference_fragment_padding_side");
            x = this.getResources().getDimensionPixelSize(Integer.parseInt(field.get(obj).toString()));
            View viewById = view.findViewById(android.R.id.list);
            viewById.setPadding(x,0,x,0);
        } catch (Exception e1) {
        }
        return view;
	}
